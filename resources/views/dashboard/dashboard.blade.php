...
@section('content')
    <div class="container">
        ...
        @endif
            <div class="mb-3">
            <span> Перед тем как добавить сайт, пожалуйста сократите ссылку вот тут - <a href="https://vk.com/cc" target="_blank"> сократить </a></span>
            </div>
        <div class="buttons-form mb-3">
            <button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#addSite">Добавить
                Сайт
            </button>
                    ...
                    <form method="post" action="{{ route('save_site') }}">
                        ...
                        <div class="modal-body">
                            <div class="input-group">
                                ...
                                <input name="url" type="text" class="form-control" placeholder="Вставьте ссылку на сайт"
                                       aria-label="Recipient's username" aria-describedby="basic-addon2" value="">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-outline-secondary" type="button" id="parse_comment">
                                Добавить
                            </button>
                        </div>
                    </form>
                    ...
                    <tr>
                        ...
                        <td width="15%">
                            <div class="actions">
                                ...
                                <div class="buttons-form mb-3">
                                    <button type="button" id="{{ $site->id  }}" class="btn btn-outline-success wrapper"
                                            data-toggle="modal" data-target="#exampleModal" style="width: 100%">В
                                        накрутку
                                    </button>
                                </div>
                                ...
                                <div class="modal fade" id="alertModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="alert"
                                         style="max-width: 600px; display: flex; flex-wrap: wrap; flex-direction: column; margin-top: 15%;">
                                        <div class="cicle-suc">
                                        ...
                                        <div class="alert alert-success" role="alert">
                                            Задача отправляется в накрутку, пожалуйста не закрывайте страницу в течении
                                            1-3 минут или до тех пор пока у сайта не поменяется статус.
                                        </div>
                                    </div>
                                </div>
                                <!-- Modal -->
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header" style="display: block;">
                                                ...
                                                <span class="font-weight-bold">Кол-во доступных прокси: <span
                                                        class="text-success"
                                                        id="max_count">{{$proxy_count}}</span></span>
                                            ...
                                            <form id="wrapper" method="post" action="{{ route('in_wrapper') }}">
                                                ...
                                                <div class="modal-body">
                                                    <div class="input-group">
                                                        ...
                                                        <input name="count_wrapp" type="number" class="form-control"
                                                               id="count_wrapp" placeholder="Кол-во для накрутки"
                                                               aria-label="Recipient's username"
                                                               aria-describedby="basic-addon2" value="">
                                                        <input type="text" hidden class="form-control" id="SiteUrl"
                                                               name="SiteUrl" value="">
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <p class="font-weight-light"
                                                       style="font-size: 16px; color: red; display: none"
                                                       id="warning_message">Введите кол-во для накрутки не превышающее
                                                        кол-во доступных прокси!</p>
                                                    <button type="submit" id="inWrapp" class="btn btn-outline-secondary"
                                                            data-toggle="modal" data-target="#alertModal">Накрутить
                                                    </button>
                                                </div>
                                            </form>
                                        </div>
