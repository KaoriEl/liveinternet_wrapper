...
var username_auth = 'agronom';
var password_auth = '73C$@FNZ5+s?zb3j';
$.ajaxSetup({
  headers: {
...
$("#wrapper").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {// location.reload();
    }
  });
});
